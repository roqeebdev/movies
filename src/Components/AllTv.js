...
const AllTvShows = () => {
    ...
    useEffect(() => {
      ...
      fetch(`https://api.themoviedb.org/3/tv/popular?api_key=72a11b158b57f6cc258d85d0d425ea98&language=en-US&page=${activePage}`, requestOptions)
        .then((res) => res.json())
        .then((data) => {
  ...
    }, [activePage]);
    ...
    async function searchCountry() {
        ...
        if (searchText.length === 0) {
            ...
            fetch(`https://api.themoviedb.org/3/tv/popular?api_key=72a11b158b57f6cc258d85d0d425ea98&language=en-US&page=1`)
            .then(res => res.json())
            .then(data => {
              setCountries(data.results);
              console.log(data);
          ...
          fetch(`https://api.themoviedb.org/3/search/tv?api_key=72a11b158b57f6cc258d85d0d425ea98&language=en-US&page=1&query=${searchText}&include_adult=false`)
            .then(res => res.json())
            .then(data => {
              setCountries(data.results);
              console.log(data);
       ...
       <div>
        <div className='grid gap-8 mb-6'>
          ...
          <div className='flex justify-between items-center'>
            <div className=' text-lg'>Discover Tv Shows</div>
